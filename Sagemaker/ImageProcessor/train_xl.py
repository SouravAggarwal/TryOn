...
def parse_args():
    ...
    parser.add_argument("--pretrained_ip_adapter_path",type=str,default=f"{config_path.CKPT_PATH}/ip_adapter/ip-adapter-plus_sdxl_vit-h.bin",help="Path to pretrained ip adapter model. If not specified weights are initialized randomly.",)
    parser.add_argument("--image_encoder_path",type=str,default=f"{config_path.CKPT_PATH}/image_encoder",required=False,help="Path to CLIP image encoder",)
